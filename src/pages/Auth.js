...
function Auth({ login, register, isLogedIn, setIsLogedIn }) {
  ...
  const onSubmitHandler = (e) => {
    e.preventDefault();
    if (login) {
      axios.post(`https://eshop.reskimulud.my.id/products${getBaseUrl()}/login`, { email, password })
        .then(res => {
    ...
    if (register) {
      axios.post(`https://eshop.reskimulud.my.id/products${getBaseUrl()}/register`, { name, email, password })
        .then(res => {
